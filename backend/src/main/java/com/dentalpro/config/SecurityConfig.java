    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/clinic-holidays", "/api/v1/clinic-holidays/*").hasAnyRole("ADMIN", "DENTIST")
                .requestMatchers(HttpMethod.POST, "/api/v1/clinic-holidays").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/clinic-holidays/*").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/clinic-holidays/*").hasRole("ADMIN")
                .requestMatchers("/api/v1/patients/export").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/v1/patients", "/api/v1/patients/*").hasAnyRole("ADMIN", "DENTIST")
                .requestMatchers(HttpMethod.POST, "/api/v1/patients").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/patients/*").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/dentists", "/api/v1/dentists/*").hasAnyRole("ADMIN", "DENTIST")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/inventory", "/api/v1/inventory/low-stock", "/api/v1/inventory/*", "/api/v1/inventory/*/batches").hasAnyRole("ADMIN", "DENTIST")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/services", "/api/v1/services/*", "/api/v1/services/*/price-history", "/api/v1/services/chairs", "/api/v1/services/chairs/*").hasAnyRole("ADMIN", "DENTIST")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/invoices", "/api/v1/invoices/*", "/api/v1/invoices/*/items", "/api/v1/invoices/*/payments").hasAnyRole("ADMIN", "DENTIST")
